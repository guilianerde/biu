...
export default function LyricsOverlay() {
  ...
  return (
    <div
      className="window-drag flex h-screen w-screen flex-col overflow-hidden bg-transparent select-none"
      style={{ opacity }}
    >
      <div
        className="group relative m-0 flex h-full flex-col rounded-none border-0 shadow-none"
